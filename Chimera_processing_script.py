...
directoryName = "/Users/matthewrobinson/Documents/spyder/scratch/Ecoli_structures_test"
...
file_names = ["/Users/matthewrobinson/Documents/spyder/scratch/Ecoli_structures_test/E10022.pdb"]
...
#        rc("select :arg@cd|:lys@ce|:pro@cd|:thr@cb|:trp@cd1")
        ...
        for a in atoms:
                areaSAS = a.areaSAS #won't this just all be 0's
                residue = a.residue
                type = residue.type
...
### EXAMPLE OF LOOKING UP A KEY AND RETURNING A VALUE FROM A DICTIONARY
                ...
                string = re.sub(r" TRP ", ":", string) #why are we including trytophan in here
        ...
        depthDict = dict({})
        minDepth = 1000000 #what is this value doing?
        rc("select #0")
        rc("~select #0:@")
